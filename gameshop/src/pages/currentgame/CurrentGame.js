            ...
            <div className="col-lg-4 col-12 ">
                <div className='boxgame' style={{margin:"40px auto"}}>
                    <div className="imggame">
                        <img className='w-100' src={currentitem.imageUrl} alt="rasim"/>
                    </div>
                    <div className="textgame mt-3 mb-2">
                        ...
                        <a href={currentitem.torrentUrl} download className='mt-3'>
                            <button className='mt-3 btn btn-warning' type="button"><h6>Cкачать безплатно</h6></button>
                        </a>
                    </div>
                </div>
            </div>
